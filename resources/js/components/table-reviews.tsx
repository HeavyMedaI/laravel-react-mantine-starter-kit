import { Anchor, Group, Progress, Table, Text, Checkbox } from '@mantine/core';
import classes from '../../css/Mantine/TableReviews.module.css';
...
export function TableReviews() {
    const rows = data.map((row, index) => {
        ...
        return (
            <Table.Tr key={'row-' + row.title + '-' + index}>
                <Table.Td>
                    <Checkbox
                        color="cyan"
                    />
    ...
    return (
        <Table.ScrollContainer minWidth={800} className="w-full">
            <Table verticalSpacing="sm">
                <Table.Thead className="text-gray-700 text-center">
                    <Table.Tr>
                        <Table.Th>
                            <Checkbox
                                defaultChecked
